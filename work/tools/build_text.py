...
ELF_WIDTH_OVERRIDE = {
    ...
    # 2026-09-20 정발판 표기 반영. 같은 목록에 城塞(4칸)·土砂·土塁가 있어 4칸까지 들어간다
    0x353920: 4,    # 砦 -> 요새   (공작물 선택 목록)
    0x353928: 4,    # 櫓 -> 망루
    0x353938: 4,    # 柵 -> 목책
    0x353E30: 4,    # 砦 -> 요새   (공작물 종류 표 2)
    0x353E38: 4,    # 櫓 -> 망루
    0x353E48: 4,    # 柵 -> 목책
    0x353E50: 4,    # 柵 -> 목책
    0x352E68: 6,    # ｱｲﾃﾑ -> 아이템 (무장정보 탭. 단추 폭은 열전·능력과 같고 여유가 있다)
}
